...
const styles = StyleSheet.create({
    ...
    title: { fontSize: 34, fontWeight: '900', marginBottom: 20, letterSpacing: -0.5 },
    ...
    startTitle: { fontSize: 24, fontWeight: '900', color: '#FFFFFF', marginBottom: 6, letterSpacing: -0.5 },
    ...
    activeTitle: { fontSize: 24, fontWeight: '900', letterSpacing: -0.5 },
    ...
    exerciseName: { fontSize: 18, fontWeight: '900', letterSpacing: -0.3 },
    ...
    summaryTitle: { fontSize: 26, fontWeight: '900', letterSpacing: -0.5, textAlign: 'center', marginBottom: 8 },
