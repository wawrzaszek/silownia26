      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <Animated.View entering={FadeInUp.delay(200).springify()} style={styles.header}>
            <ThemedText type="title">Witaj ponownie</ThemedText>
            <ThemedText type="subtitle" style={styles.subtitle}>
              Zaloguj się, aby kontynuować swoje treningi.
            </ThemedText>
          </Animated.View>
            ...
            <GlassView style={styles.formCard} intensity={40}>
              ...
              >
                {loading ? (
                  ...
                  <>
                    <ThemedText style={styles.submitButtonText}>Zaloguj się</ThemedText>
          ...
          <Animated.View entering={FadeInDown.delay(600).springify()} style={styles.footer}>
            <ThemedText style={styles.footerText}>Nie masz jeszcze konta?</ThemedText>
            <TouchableOpacity onPress={() => router.push('/auth/signup' as any)}>
              <ThemedText type="link">Załóż konto</ThemedText>
            </TouchableOpacity>
          </Animated.View>
        </ScrollView>
      </KeyboardAvoidingView>
